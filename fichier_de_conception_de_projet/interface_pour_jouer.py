...
"")
    ...
    def fermer_et_ouvrir_fenetres(self):
        ...
        Form.close()  # Ferme la fenêtre actuelle



class Ui_MainWindow(object):
    def __init__(self, formCombat):
        self.formCombat = formCombat
    ...
    def keyPressEvent(self, event):
        ...
        for label in self.main_window.pokemon_labels:
            ...
            if distance < 20:  # 20 pixels est la distance approximative entre le centre du carré et le coin
                ...
                global is_combat_global
                is_combat_global = True
                print("**test**")
...
ui_main_window = Ui_MainWindow(tig.Form)
