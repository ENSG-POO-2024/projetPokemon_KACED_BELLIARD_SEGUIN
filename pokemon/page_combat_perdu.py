...
# Form implementation generated from reading ui file 'page-combat-perdu.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(10, 13, 371, 271))
        self.label.setText("")
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(300, 180, 75, 23))
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(90, 110, 201, 51))
        self.pushButton_4.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("bouton perdu.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
